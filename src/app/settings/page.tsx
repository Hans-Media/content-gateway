...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-10 flex flex-col gap-6">
      ...
      <Card
        title="✨ AI Caption (Claude)"
        subtitle="Isi API key dari console.anthropic.com supaya tombol 'Generate Caption (AI)' di halaman Upload bisa jalan — AI akan lihat foto/frame video kamu dan bikinkan caption otomatis."
        connected={!!settings.anthropic?.apiKey}
      >
        <Field
