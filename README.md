...
## Auto-caption pakai AI (Claude)

Di halaman Upload ada tombol **✨ Generate Caption (AI)**. Ini yang perlu disiapkan:

1. Buat API key di [console.anthropic.com](https://console.anthropic.com/settings/keys).
2. Tempel di Settings → bagian **AI Caption (Claude)**.
